				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员特点：</td>
								<td><input type="checkbox"id="expressTrait1" name="expressTrait" value="耐心"
									class="" aria-required="true" required/>耐心
									<input type="checkbox"id="expressTrait2" name="expressTrait" value="干练"
									class="" aria-required="true" required/>干练
									<input type="checkbox"id="expressTrait3" name="expressTrait" value="效率"
									class="" aria-required="true" required/>效率
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
	...
	<div class="modal fade" id="modal_user_count" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 人员信息报表  </h4>
				</div>
				<div class="modal-body">
	    	...
	    	$("#btn_count").click(function(){
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
						...
						var xdate=[];
	    		        var ydate=[];
	    		        res.date.forEach(function(vo){
	    		        	xdate.push(vo.cname);
	    		        	ydate.push({value:vo.num,name:vo.cname});
	    		        });
